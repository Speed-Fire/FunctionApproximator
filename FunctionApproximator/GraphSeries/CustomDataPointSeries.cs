...
namespace FunctionApproximator.GraphSeries
{
	...
	/// Provides an abstract base class for series that contain a collection of <see cref="DataPoint" />s.
	/// </summary>
	public abstract class CustomDataPointSeries : CustomXYAxisSeries
    {
        public ReadOnlyMemory<double> RawPoints { get; set; } = Array.Empty<double>();

        public ReadOnlySpan<DataPoint> ActualPoints =>
            MemoryMarshal.Cast<double, DataPoint>(RawPoints.Span);
        ...
        public override TrackerHitResult GetNearestPoint(ScreenPoint point, bool interpolate)
        {
            ...
            if (result != null)
            {
                result.Text = StringHelper.Format(
                    ...
                    result.Item,
                    this.Title,
                    this.XAxis.Title ?? CustomXYAxisSeries.DefaultXAxisTitle,
                    this.XAxis.GetValue(result.DataPoint.X),
                    this.YAxis.Title ?? CustomXYAxisSeries.DefaultYAxisTitle,
        ...
        protected override object GetItem(int i)
        {
            ...
            if (this.ItemsSource == null && actualPoints != null && i < actualPoints.Length)
            {
        ...
        private void UpdateItemsSourcePoints()
        {
            ...
            else
            {
                ...
                filler.Fill(this.itemsSourcePoints, this.ItemsSource, args => new DataPoint(OxyPlot.Axes.Axis.ToDouble(args[0]), OxyPlot.Axes.Axis.ToDouble(args[1])));
            }
        }
    }
}