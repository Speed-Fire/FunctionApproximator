...
namespace OxyPlot.Series
{
    ...
    public abstract class Series : PlotElement
    {
        ...
        /// 
        /// </summary>
        public bool HasRenderWithRect { get; protected set; } = false;

		/// <summary>
		/// Renders the series on the specified render context.
		/// </summary>
		/// <param name="rc">The rendering context.</param>
		/// <param name="rect">The rendering context.</param>
		public virtual void Render(IRenderContext rc, ref OxyRect rect) { }
