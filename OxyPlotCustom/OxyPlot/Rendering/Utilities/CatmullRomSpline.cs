	...
	public class CatmullRomSpline : IInterpolationAlgorithm
    {
        ...
        public List<DataPoint> CreateSpline(List<DataPoint> points, bool isClosed, double tolerance)
        {
            return CreateSpline(CollectionsMarshal.AsSpan(points),
                this.Alpha, isClosed, tolerance, MaxSegments);
        }
        ...
        /// <returns>A list of data points.</returns>
        internal static List<DataPoint> CreateSpline(ReadOnlySpan<DataPoint> points, double alpha, bool isClosed, double tolerance, int maxSegments)
        {
